...
import (
	...
	"getitqec.com/server/mailnotification/pkg/protocol/grpc/middleware"
	"google.golang.org/grpc"
	"google.golang.org/grpc/credentials"
)

// RunServer ...
func RunServer(ctx context.Context, service pb.MailNotificationServiceServer, port string, certFilePath string, keyFilePath string) error {
	...
	pb.RegisterMailNotificationServiceServer(grpcServer, service)
